'''
Quick script with many available plot modificaitons of an isolated galaxy.
'''
...
#d_path = '/mnt/research/galaxies-REU/sims/isolated-galaxies/MW_1638kpcBox_800pcCGM_200pcDisk_lowres/%s/%s' % (dd, dd)
d_path = '/mnt/c/scratch/sciteam/dsilvia/simulations/galaxy_simulation/reu_sims/MW_1638kpcBox_800pcCGM_200pcDisk/thermalFB/%s/%s' % (dd, dd)
ds = yt.load(d_path)
